...
import { SentenceComponent } from 'app/entities/sentence/sentence.component';
...
describe('Component Tests', () => {
    describe('Sentence Management Component', () => {
        let comp: SentenceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SentenceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sentences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
